...
{   int ch,y=0;
    ...
    do
    {
      cout<<"\n Data inserted from array a" << endl;
      cout<<"\nRED BLACK TREE ";
                cout<<"\n 1. Delete a node from the tree from index ";
                cout<<"\n 2. Search for an element in the tree from index";
                cout<<"\n 3. Display the tree ";
                cout<<"\n 4. Exit " ;
                cout<<"\nEnter Your Choice: ";
                cin>>ch;
                switch(ch)
                {
                          case 1 :  int dd;   // enter index of the number to be deleted
                                    cout<<"\nEnter the index of element to be deleted: ";
                                    cin >> dd;
                                    bst.deleteNode(a[dd]);
                                    break;
                          case 2 :
                                int ss;   // enter index of the element
                                cout<<"\nEnter the index of the element to be searched: ";
                                cin>>ss;
                                bst.searchTree(a[ss]);
                                break;
                          case 3 : bst.display_data();
                                   break;
                          case 4 : y=1;
                                   break;
